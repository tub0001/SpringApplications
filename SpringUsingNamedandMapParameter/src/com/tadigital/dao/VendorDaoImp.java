...
public class VendorDaoImp implements VendorDao{
	...
	public boolean loginProcess(Vendor v) {
		String sql = "SELECT * FROM test1 WHERE Email = :vemail AND Password = :vpassword";
		Vendor ven = new Vendor();
		MapSqlParameterSource parameters = new MapSqlParameterSource();
		parameters.addValue("vemail", v.getUname());
	...
	public boolean registerVendor(Vendor v) {
		String sql = "INSERT INTO test1(Name,Email,Password) VALUES(:vname,:vemail,:vpassword);";
	...
	public List<Vendor> deleteVendor(int vid) {
		String sql = "DELETE from test1 WHERE Id = :vid";
	...
	public Vendor editVendor(int vid) {
		String sql = "SELECT * FROM test1 WHERE Id = :vid";
		Vendor v = new Vendor();
		MapSqlParameterSource parameters = new MapSqlParameterSource();
		parameters.addValue("vid", vid);
		try {
	...
	public boolean updateVendor(Vendor v) {
		String sql = "UPDATE test1 SET Name= :vname, Email = :vemail WHERE Id= :vid";
